...
const FoodLifestylePage = () => {
  const category = getCategoryBySlug("food-lifestyle")!;
  const { data: news = [], isLoading } = useArticlesByCategory("food-lifestyle", 30);
...
export default FoodLifestylePage;
